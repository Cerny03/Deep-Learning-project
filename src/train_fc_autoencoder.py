...
def save_loss_curve(
    ...
    axis.set_title("Fully connected denoising autoencoder")
    axis.legend()
    axis.grid(True)
    ...
    output_path = FIGURE_DIR / "fc_autoencoder_loss.png"
...
def save_reconstruction_figure(
    ...
    image_groups = [
        ("Clean", clean_images),
        ("Noisy", noisy_images),
        ("FC autoencoder", reconstructed_images),
    ]
    ...
    figure.suptitle(
        f"Fully connected autoencoder, noise sigma = {NOISE_SIGMA}"
    )
    ...
    output_path = (
        FIGURE_DIR
        / "fc_autoencoder_reconstructions.png"
    )
    ...
    print("Reconstruction figure saved in:", output_path)
